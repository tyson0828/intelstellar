var WATCHAPP_SERVICE = '19B10000-E8F2-537E-4F6C-D104768A1214';
var WATCHAPP_CHARACTERISTIC = '19B10001-E8F2-537E-4F6C-D104768A1214';
...
var app = {
    ...
    scan: function() {
        scanButton.hidden = true;
        ble.startScan([WATCHAPP_SERVICE], app.onDiscoverDevice, app.onError);
    },
    ...
    onData: function(buffer) {
        ...
        var localNotification = {
            title: 'WatchApp',
            text: 'Approaching in ' + data[0] + ' inches'
        };
        cordova.plugins.notification.local.schedule(localNotification);
    },
